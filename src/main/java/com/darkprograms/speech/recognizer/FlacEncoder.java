...
/*************************************************************************************************************
 * Class that contains methods to encode Wave files to FLAC files THIS IS THANKS
 * TO THE javaFlacEncoder Project created here:
...
public class FlacEncoder {
	...
	/**
	 * Converts a wave file to a FLAC file(in order to POST the data to Google and
	 * retrieve a response) <br>
